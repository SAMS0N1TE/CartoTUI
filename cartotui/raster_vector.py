...
def default_style(theme: str = "amber") -> VectorStyle:
    ...
    if theme == "hicon":
        # Pure black on white. Roads are black-graded by class so motorways
        # are still distinguishable. No middle-grey tones — they fall below
        # the threshold and disappear on a white background anyway.
        return VectorStyle(
            bg=(255, 255, 255),
            water=(140, 170, 200),
            park=(180, 220, 180),
            ...
            road_colors={
                ...
                4:  (90, 90, 90),  3: (105, 105, 105),
                2: (120, 120, 120), 1: (135, 135, 135),
            },
        )
    if theme == "ega":
        # 16-color EGA palette. Each color picked from the actual EGA
        # 64-color superset so it'd render identically on a real EGA
        # adapter. Distinct colors for water (blue), parks (green),
        # roads (white/yellow grade), labels (bright white), aircraft
        # (yellow). This is the "DeLorme TopoUSA 1995" look.
        return VectorStyle(
            bg=(0, 0, 0),                  # black background
            water=(0, 0, 170),             # EGA blue
            park=(0, 170, 0),              # EGA green
            building=(170, 170, 170),      # EGA light grey
            road_color=(255, 255, 255),    # bright white
            label_color=(255, 255, 85),    # EGA bright yellow
            halo_color=(0, 0, 0),
            ...
            road_colors={
                10: (255, 255, 255),  # motorway: bright white
                9:  (255, 255, 85),   # trunk: yellow
                8:  (255, 255, 85),   # primary: yellow
                7:  (170, 170, 170),  # secondary: light grey
                6:  (170, 170, 170),
                5:  (85, 85, 85),     # tertiary: dark grey
                4:  (85, 85, 85),
                3:  (85, 85, 85),     # minor: dark grey
                2:  (85, 85, 85),
                1:  (85, 85, 85),
            },
        )
    if theme == "win31":
        # Windows 3.1 vector palette. The map renders with the
        # canonical Win 3.1 16-color VGA set: water as bright blue,
        # parks as bright green, roads as white, labels as bright
        # yellow. All colors are pure index values (no in-betweens),
        # which is faithful to the era — Win 3.1 had no concept of
        # smooth gradients in the chrome.
        return VectorStyle(
            bg=(0, 0, 0),                       # black background
            water=(0, 0, 255),                  # bright blue
            park=(0, 128, 0),                   # darkgreen
            building=(192, 192, 192),           # lightgray
            road_color=(255, 255, 255),         # white
            label_color=(255, 255, 0),          # yellow
            halo_color=(0, 0, 0),
            aircraft_color=(255, 255, 0),       # yellow
            aircraft_selected_color=(255, 255, 255),
            aircraft_emergency_color=(255, 0, 0),
            aircraft_label_color=(255, 255, 255),
            aircraft_halo_color=(0, 0, 0),
            road_colors={
                10: (255, 255, 255),  # motorway: white
                9:  (255, 255, 0),    # trunk: yellow
                8:  (255, 255, 0),    # primary: yellow
                7:  (192, 192, 192),  # secondary: lightgray
                6:  (192, 192, 192),
                5:  (128, 128, 128),  # tertiary: gray
                4:  (128, 128, 128),
                3:  (128, 128, 128),
                2:  (128, 128, 128),
                1:  (128, 128, 128),
    ...
    if theme == "night":
        # Pure black + deep red. Single-hue mode — like Hercules
        # monochrome but in red instead of amber. All map features
        # rendered in shades of red against black. Designed for
        # night-watch use where you don't want bright whites/blues
        # blowing your dark-adapted vision.
        return VectorStyle(
            bg=(0, 0, 0),
            water=(50, 0, 0),                 # very deep red — water hint
            park=(80, 0, 0),                  # mid-deep red — landuse
            building=(100, 0, 0),
            road_color=(220, 30, 30),
            label_color=(255, 50, 50),        # brightest red for labels
            halo_color=(0, 0, 0),
            aircraft_color=(255, 60, 60),
            aircraft_selected_color=(255, 200, 200),
            aircraft_emergency_color=(255, 255, 255),  # WHITE for emergencies in night mode
            aircraft_label_color=(255, 100, 100),
            aircraft_halo_color=(0, 0, 0),
            road_colors={
                10: (255, 50, 50),
                9:  (220, 40, 40),
