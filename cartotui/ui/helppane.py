...
_HELP_LINES = [
    ...
    ("kv",    " ┃   c           toggle colour                              ┃ "),
    ("kv",    " ┃   N           toggle map labels (place names)            ┃ "),
    ("kv",    " ┃   u           cycle threshold (percentile/edge/fixed)    ┃ "),
    ("text",  " ┃                                                          ┃ "),
    ("text",  " ┃   AIRCRAFT (ADS-B)                                       ┃ "),
    ("kv",    " ┃   a           labels: smart / all / selected / none      ┃ "),
    ("kv",    " ┃   n           density: 50 / 150 / 500 / all shown        ┃ "),
    ("kv",    " ┃   G           toggle ground traffic                      ┃ "),
    ("kv",    " ┃   f           follow selected aircraft (recenter)        ┃ "),
    ("text",  " ┃                                                          ┃ "),
    ("text",  " ┃   IMAGE ADJUST                                           ┃ "),
    ("kv",    " ┃   [ / ]       brightness  -/+                            ┃ "),
    ("kv",    " ┃   { / }       contrast    -/+                            ┃ "),
    ("kv",    " ┃   ( / )       gamma       -/+                            ┃ "),
    ("kv",    " ┃   < / >       saturation  -/+                            ┃ "),
    ("kv",    " ┃   ; / :       black point -/+  (lift a dark theme)       ┃ "),
    ("kv",    " ┃   ' / \"       white point -/+  (tame a bright theme)     ┃ "),
    ("kv",    " ┃   \\           reset image adjust                         ┃ "),
    ("text",  " ┃                                                          ┃ "),
    ("text",  " ┃   PLACES                                                 ┃ "),
    ("kv",    " ┃   g           goto lat,lon                               ┃ "),
    ("kv",    " ┃   r           reset to home                              ┃ "),
